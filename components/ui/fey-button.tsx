...
export function FeyButton({ className, children, ...props }: FeyButtonProps) {
  ...
  return (
    <button
      className={cn(
        "group relative flex h-8 min-w-[136px] items-center justify-center gap-1 whitespace-nowrap rounded-[28px] px-3 py-2 text-sm font-semibold leading-tight text-foreground",
        isDark
        ...
        "hover:after:opacity-100 disabled:cursor-not-allowed disabled:opacity-50",
        className,
      )}
      {...props}
    >
